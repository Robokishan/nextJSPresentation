  ...
  return (
    <>
      ...
      <p>
        ...
        paragraph to create a short story. Unlike the
        <a href="https://randomwordgenerator.com/sentence.php">
          random sentence generator
        </a>
        , the sentences from the random paragraph will have some connection to
        one another so it will be a bit different. You also won't know exactly
